...
This file contains the instructions for the Project EARS-PIO-WSS3-LVGL-005.  
...
All documents are to be headed by a Revision Number Block that is appropriate to the comment style of the document type. Which is to be updated by both the AI assistant and myself whenever the content of the underlying document or page is changed and presented.
